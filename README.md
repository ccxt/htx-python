...
- `fetch_account_id_by_type(self, type: str, marginMode: Str = None, symbol: Str = None, params: dict = {})`
...
- `fetch_closed_contract_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_closed_spot_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_contract_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_isolated_borrow_rates(self, params: dict = {})`
...
- `fetch_markets_by_type_and_sub_type(self, type: Str, subType: Str, params: dict = {})`
...
- `fetch_open_interest_history(self, symbol: str, timeframe: str = '1h', since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_spot_order_trades(self, id: str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_spot_orders_by_states(self, states: Str, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_spot_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
...
- `fetch_trades(self, symbol: str, since: Int = None, limit: Int = 1000, params: dict = {})`
- `fetch_trading_fee(self, symbol: str, params: dict = {})`
- `fetch_trading_limits_by_id(self, id: Str, params: dict = {})`
- `fetch_trading_limits(self, symbols: Strings = None, params: dict = {})`
- `fetch_transfers(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `fetch_withdraw_addresses(self, code: str, note: Str = None, networkCode: Str = None, params: dict = {})`
...
- `cost_to_precision(self, symbol: Str, cost: object)`
- `describe(self)`
...
- `spot_private_get_v5_account_universal_transfer_records(request)`
...
- `spot_private_get_v2_invitee_rebate_referrals(request)`
- `spot_private_get_v2_invitee_rebate_detail(request)`
- `spot_private_get_v2_invitee_rebate_history(request)`
- `spot_private_get_v2_invitee_rebate_all_rebate_detail(request)`
- `spot_private_get_v2_invitee_rebate_batcher_rebate_detail(request)`
...
- `spot_private_post_v5_account_universal_transfer(request)`
...
- `contract_public_get_v5_market_funding_rate(request)`
- `contract_public_get_v5_market_funding_rate_history(request)`
- `contract_public_get_v5_market_open_interest(request)`
- `contract_public_get_v5_market_liquidation_orders(request)`
- `contract_public_get_v5_market_settlement_history(request)`
- `contract_public_get_v5_market_elite_account_ratio(request)`
- `contract_public_get_v5_market_elite_position_ratio(request)`
- `contract_public_get_v5_market_estimated_settlement_price(request)`
- `contract_public_get_v5_market_price_limit(request)`
...
- `contract_private_get_v5_account_bills(request)`
- `contract_private_get_v5_account_fee_deduction_currency(request)`
...
- `contract_private_get_v5_algo_order_opens(request)`
- `contract_private_get_v5_algo_order(request)`
- `contract_private_get_v5_algo_order_history(request)`
- `contract_private_get_api_v6_copytrading_trader_instruments(request)`
- `contract_private_get_api_v6_copytrading_trader_statistics(request)`
- `contract_private_get_api_v6_copytrading_trader_profit_sharing_history(request)`
- `contract_private_get_api_v6_copytrading_trader_profit_sharing_history_summary(request)`
- `contract_private_get_api_v6_copytrading_trader_unrealized_profit_sharing_summary(request)`
- `contract_private_get_api_v6_copytrading_trader_followers(request)`
...
- `contract_private_post_v5_trade_cancel_after(request)`
...
- `contract_private_post_v5_position_margin(request)`
- `contract_private_post_v5_account_fee_deduction_currency(request)`
- `contract_private_post_v5_algo_order(request)`
- `contract_private_post_v5_algo_cancel_orders(request)`
- `contract_private_post_api_v6_copytrading_trader_follower(request)`
- `contract_private_post_api_v6_copytrading_trader_transfer(request)`
- `contract_private_post_api_v6_copytrading_trader_follower_settings(request)`
- `contract_private_post_api_v6_copytrading_trader_config(request)`
- `contract_private_post_api_v6_copytrading_trader_apikey(request)`
...
- `un_watch_order_book(self, symbol: str, params: dict = {})`
- `watch_order_book_snapshot(self, client: Client, message: dict, subscription: dict)`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {})`
- `get_order_channel_and_message_hash(self, type: Str, subType: Str, market: Market = None, params: dict = {})`
- `get_v5_linear_channel_and_message_hash(self, topic: Str, market: Market = None, params: dict = {})`
...
- `get_url_by_market_type(self, type: object, isLinear=True, isPrivate=False, isFeed=False, isV5=False)`
- `subscribe_public(self, url: Str, symbol: Str, messageHash: Str, method: object = None, params: dict = {})`
- `unsubscribe_public(self, market: Market, subMessageHash: str, topic: str, params: dict = {})`
- `subscribe_private(self, channel: Str, messageHash: Str, type: Str, subtype: Str, params: dict = {}, subscriptionParams: dict = {})`
