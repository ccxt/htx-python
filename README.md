...
- `fetch_spot_orders_by_states(self, states: Any, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `cost_to_precision(self, symbol: Str, cost: Any)`
- `describe(self)`
...
- `watch_order_book_snapshot(self, client: Any, message: Any, subscription: Any)`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_order_channel_and_message_hash(self, type: Any, subType: Any, market: Market = None, params={})`
- `get_v5_linear_channel_and_message_hash(self, topic: Any, market: Market = None, params={})`
- `watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `watch_positions(self, symbols: Strings = None, since: Int = None, limit: Int = None, params={})`
- `watch_balance(self, params={})`
- `pong(self, client: Client, message: Any)`
- `get_url_by_market_type(self, type: Any, isLinear=True, isPrivate=False, isFeed=False, isV5=False)`
- `subscribe_public(self, url: Any, symbol: Any, messageHash: Any, method: Any = None, params={})`
- `unsubscribe_public(self, market: Market, subMessageHash: str, topic: str, params={})`
- `subscribe_private(self, channel: Any, messageHash: Any, type: Any, subtype: Any, params: Any = {}, subscriptionParams={})`
