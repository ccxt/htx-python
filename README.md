...
- `fetch_spot_orders_by_states(self, states: object, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
...
- `fetch_withdraw_addresses(self, code: str, note: Str = None, networkCode: Str = None, params={})`
...
- `watch_order_book_snapshot(self, client: object, message: object, subscription: object)`
- `watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={})`
- `get_order_channel_and_message_hash(self, type: object, subType: object, market: Market = None, params={})`
- `get_v5_linear_channel_and_message_hash(self, topic: object, market: Market = None, params={})`
...
- `subscribe_public(self, url: object, symbol: object, messageHash: object, method: object = None, params={})`
- `unsubscribe_public(self, market: Market, subMessageHash: str, topic: str, params={})`
- `subscribe_private(self, channel: object, messageHash: object, type: object, subtype: object, params: object = {}, subscriptionParams={})`
